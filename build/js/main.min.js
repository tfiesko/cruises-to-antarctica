...
},{"./modules/form-validate/form":3,"./modules/mobile-menu":9,"./modules/modals/init-modals":10,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
...
var mobilMenuLink = document.querySelectorAll('[data-nav-link]');
...
if (mobileMenu) {
  mobileMenuButton.addEventListener('click', function () {
    if (mobileMenu.classList.contains('is-open')) {
      ...
      if (mobilMenuLink) {
        mobilMenuLink.forEach(function (link) {
...
var onMobilMenuClose = function onMobilMenuClose() {
...
var onEscapeKeydown = function onEscapeKeydown(evt) {
  if (evt.key === 'Escape') {
    onMobilMenuClose();
  }
};
